...
option_vehicle_owner = ['Owner', 'Governmental', 'Organization', 'Other']

option_num_vehicles = [2, 1, 3, 6, 4, 7]

option_num_of_casualties = [2, 1, 3, 4, 6, 5, 8, 7]

option_casualty_class = ['na', 'Driver or rider', 'Pedestrian', 'Passenger']
...
features_new = ['hour', 'day_of_week', 'Defect_of_vehicle', 'Type_of_vehicle','Light_conditions','Owner_of_vehicle', 'Number_of_vehicles_involved','Number_of_casualties','Age_band_of_driver', 
